...
public record PlayerInfo(String uuid, String name, Map<String, Ranking> rankings) {
    ...
    public static CompletableFuture<Map<String, Ranking>> getNavyRankings(HttpClient client, String name) {
        String endpoint = TierTagger.getManager().getConfig().getNavyApiUrl() + "/tierlist/overall?nick=" + name;
        ...
        return client.sendAsync(request, HttpResponse.BodyHandlers.ofString())
                ...
                .thenApply(s -> {
                    ...
                    if (root == null || !root.has("data"))
                        return Collections.<String, Ranking>emptyMap();
